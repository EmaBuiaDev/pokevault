...
object ItalianTranslations {
    ...
    private val SERIES_IT = mapOf(
        ...
        "PlayPokemon" to "PlayPokemon",
        "TrickOrTreat" to "TrickOrTreat",
        "EvolutionCollection" to "EvolutionCollection",
        "McDonaldsCollection" to "McDonaldsCollection",
        "e-Card" to "e-Card",
        "Legendary Collection" to "Legendary Collection",
        "Neo" to "Neo",
        "Gym" to "Gym",
        "Base" to "Base",
        "Other" to "Altro"
